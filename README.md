...
<div align="center"><img src="assets/screenshots1.jpg" width="200px" style="display:inline-block;"><img src="assets/screenshots2.jpg" width="200px" style="display:inline-block;"><img src="assets/screenshots3.jpg" width="200px" style="display:inline-block;"><img src="assets/screenshots4.jpg" width="200px" style="display:inline-block;"><img src="assets/screenshots5.jpg" width="200px" style="display:inline-block;"></div>
...
- [Configuration instructions](#configuration-instructions)
    ...
    - [Changing theme color (optional)](#changing-theme-color-optional)
...
- The app is available on the android devices for now.
...
- Using it in Android mobile devices and ability to create iOS and web applications with the existing React Native code
...
The app is an online app which means it needs both **client-side** (developed by React Native) and **server-side** (developed by PHP and MySQL) development.<br>
...
There are 2 main part for building this app from scratch.<br>
- **Client-side:** You can access the codes related to the React Native app in the project files (App.js, app.json, and package.json). After downloading these files, you have to generate the android apk file (or iOS). For doing this you can use <a href="https://docs.expo.dev/workflow/expo-cli/">**expo cli**</a>. Also, there is a instruction (<a href="https://docs.expo.dev/classic/building-standalone-apps/">**click here**</a>) for making the app in the expo website that you have to follow for this purpose.

- **Server-side:** For this section, we used PHP and MySQL. Thus, you have to prepare a linux hosting service. Then, you have 2 steps for making this section works:<br>
...
2. Go to the line 37 and change it base on your database information:
```cpp
...
2. Go to the line 70 and change it base on your hosting information:
```cpp
fetch("YOUR_HOST_ADDRESS/API.php?action=login", {
```
3. Go to the line 168 and change it base on your hosting information:
```cpp
fetch("YOUR_HOST_ADDRESS/API.php?action=retrievematchpage", {
```
4. Go to the line 222 and change it base on your hosting information:
```cpp
fetch("YOUR_HOST_ADDRESS/API.php?action=resetmatch", {
```

### Changing theme color (optional)
1. Open App.js file with a text editor.
2. Go to the line 326 and change it **from**:
```cpp
...
2. Go to the line 89 and change it **from**:
```cpp
...
1.	The time when an egg shows to the players of a match may be different for some players (synchronization problem). <br>
    **Suggested way to solve:** setting a specific time for showing the egg to all players in the server-side code and sending this time to the client-side and using it as the next request time
